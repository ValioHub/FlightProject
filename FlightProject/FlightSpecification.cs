...
namespace FlightProject
{
    public class FlightSpecification
    {
        ...
        public void Remembers_bookings()
        {
            ...
            flight.Book(passengerEmail: "email@email.com", numberOfSeats: 4);
            ...
            int numberofSeatsTOBook, int numberOfSeatsToCancel, int remainingNumberOfSeats)
        {
            ...
            flight.Book(passengerEmail: "email@email.com", numberOfSeats: numberofSeatsTOBook);
            
            // When
            flight.CancelBooking(passengerEmail: "email@email.com", numberOfSeats: numberOfSeatsToCancel);
